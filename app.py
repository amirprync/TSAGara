...
st.sidebar.title("Transferencias Ceci")
    ...
    if filename:
        ...
        for valor,comit in enumerate(tablero['Comitente']):
            ...
            if especie!="nan" and cuotas!="nan" and comitente!="nan":
               ...
               # lista_suscri.append("1'I'E'0046'"+comitente+"'"+especie+"       '"+cuotas+"'0046'111111111'N'00'2111'0000'N"+"\r\n")
                lista_suscri.append("1'I'E'0046'111111111'"+especie+"       '"+cuotas+"'0046'"+comitente+"'N'00'0000'0000'N"+"\r\n")       
